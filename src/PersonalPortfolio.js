            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-lg text-[#8B4513]/80 leading-relaxed">
                  ...
                  data science and programming, through use of SQL, python, .
                </p>
                <p className="text-lg text-[#8B4513]/80 leading-relaxed">
    ...
    >
        ...
        <div className="flex justify-center">
          <div className="relative">
            <div className="w-64 h-64 bg-[#f5f2ed] flex items-center justify-center shadow-xl">
              <p className="text-[#8B4513] text-center font-medium">Work Photo </p>
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="flex justify-center md:order-1">
          <div className="relative">
            <div className="w-64 h-64 bg-[#f5f2ed] flex items-center justify-center shadow-xl">
              <p className="text-[#8B4513] text-center font-medium">Work Photo 2</p>
            </div>
            
            <div 
              className="absolute inset-0 pointer-events-none bg-cover bg-center bg-no-repeat"
              style={{
                backgroundImage: 'url(/leahy.jpg)',
                backgroundSize: 'contain',
              }}
            ></div>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-12">
                {[
                  { label: 'Email', value: '8626Jess@gmail.com' },
                  { label: 'LinkedIn', value: 'https://www.linkedin.com/in/jessicamcilree/' },
                ].map((contact, i) => (
                  <div 
                    key={contact.label}
